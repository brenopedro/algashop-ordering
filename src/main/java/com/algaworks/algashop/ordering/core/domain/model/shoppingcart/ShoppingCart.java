...
public class ShoppingCart extends AbstractEventSourceEntity implements AggregateRoot<ShoppingCartId> {
    ...
    public void removeItem(ShoppingCartItemId shoppingCartItemId) {
        ...
        this.publishDomainEvent(new ShoppingCartItemRemovedEvent(this.id(), this.customerId(),
                shoppingCartItem.productId(), OffsetDateTime.now()));
    }
    ...
    public void addItem(Product product, Quantity quantity) {
        ...
        this.publishDomainEvent(new ShoppingCartItemAddedEvent(this.id(), this.customerId(),
                product.id(), OffsetDateTime.now()));
    }
