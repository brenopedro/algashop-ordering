...
class CustomersIT extends AbstractDomainIT {
    ...
    void shouldNotFindByEmail() {
        Optional<Customer> possibleCustomer = customers.ofEmail(new Email(UUID.randomUUID() + "@example.com"));
    ...
    void shouldReturnIfEmailIsInUse() {
        ...
        assertThat(customers.isEmailUnique(new Email(UUID.randomUUID() + "@example.com"), new CustomerId())).isTrue();
    }
 }